      ...
      body: PageView(
        ...
        children: <Widget>[
          Question(
              ...
              onChange: (value) {
                setState(() {
                  calcMethod.ont = double.parse(value);
                });
              }),
          Question(
              text: 'Valor gasto\n' 'até o momento',
              onChange: (value) {
                setState(() {
                  calcMethod.ont_2 = double.parse(value);
                });
              }),
          Question(
              text: 'Prazo\n' 'planejado',
              onChange: (value03) {
                setState(() {
                  calcMethod.tt = double.parse(value03);
                });
              }),
          Question(
              text: 'Prazo\n' 'cumprido',
              onChange: (value04) {
                setState(() {
                  calcMethod.ont = double.parse(value04);
                });
              }),
          Result(
